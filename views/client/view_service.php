<div class="stoneflow-client-panel">
    ...
    <?php if (!empty($service)) : ?>
        <table class="stoneflow-table">
            <tr>
                <th>Service</th>
                <td><strong><?= esc_html($service['service_name']) ?></strong></td>
            </tr>
            <tr>
                <th>Status</th>
            ...
            <tr>
                <th>Admin Notes</th>
                <td><?= !empty($service['admin_notes']) ? esc_html($service['admin_notes']) : '—' ?></td>
            </tr>
            <tr>
                <th>Your Notes</th>
                <td><?= !empty($service['client_notes']) ? esc_html($service['client_notes']) : '—' ?></td>
            </tr>
        </table>
    <?php else : ?>
