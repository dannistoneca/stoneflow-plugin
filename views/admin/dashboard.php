<div class="wrap stoneflow-admin">
	...
	<table class="widefat fixed striped">
		...
		<?php if ( ! empty( $clients ) ) : ?>
			...
			<tr>
				...
				<td><?php echo $client->discovery_info ? 'Available' : 'No data'; ?></td>
				<td>
				<a href="<?php echo admin_url( 'admin.php?page=stoneflow-client&client_id=' . $client->id ); ?>" class="button">View</a>
				</td>
			</tr>
			<?php endforeach; ?>
		<?php else : ?>
	...
	<h2>Service Queue</h2>
	<?php require plugin_dir_path( __FILE__ ) . 'services-table.php'; ?>
	</div>

	<div id="notes" class="sf-tab-content hidden">
	<h2>Admin Notes</h2>
	<?php require plugin_dir_path( __FILE__ ) . 'admin-notes.php'; ?>
	</div>
</div>
