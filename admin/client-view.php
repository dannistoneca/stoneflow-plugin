...
function stoneflow_view_client_page() {
	...
	<div class="wrap">
		...
		<hr>
		<h2>📦 Services</h2>
		<p><?php echo $client->services ? nl2br( esc_html( $client->services ) ) : 'No services found.'; ?></p>

		<hr>
		<h2>📝 Admin Notes</h2>
		<form method="post">
			<textarea name="admin_notes" rows="6" style="width: 100%;"><?php echo esc_textarea( $client->admin_notes ); ?></textarea>
			<br><br>
